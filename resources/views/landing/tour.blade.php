    ...
    <section class="font-inter" >   
        <div class="container px-24 pb-24 mx-auto">
            <div class="flex flex-wrap w-full mb-10">
                ...
                <div class="flex flex-wrap my-3-m-4 mx-auto font-inter">
                @foreach($tour as $item)
                    <div class="xl:w-1/4 md:w-1/2 sm:w-1/1 p-4 mx-auto">                           
                        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="p-5">
                                <a href="{{ route('detail-tour.index') }}">
                                    <h5 class="mb-3 text-2xl font-bold tracking-tight text-gray-900 hover:text-gray-400 dark:text-white">{{ $item->judul }}</h5>
                                </a>
                                ...
                                <div class="flex items-center justify-between">
                                    <span class="text-lg font-bold text-yellow-600 ">{{ $item->harga }}</span>
                                    <span class="text-base font-medium text-gray\ ">{{ $item->namaagen }}</span>                                      
                                </div>
                            </div>
                        </div>
                    </div>
