    ...
    <body class="bg-gray-100">
        ...
        <section class="text-gray-600 body-font">
            <div class="container px-24 pt-16 mx-auto">
                <div class=" mb-10">
                    <h1 class="sm:text-3xl lg:text-5xl font-bold title-font text-gray-900 mb-4">DETAIL TRANSAKSI</h1>
                </div>
            </div>
        </section>

        <section class="text-gray-600 body-font">
            <div class="container mx-auto flex px-24 pt-10 md:flex-row flex-col items-center">
