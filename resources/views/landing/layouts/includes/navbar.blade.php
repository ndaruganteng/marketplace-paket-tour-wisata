        ...
        <nav class="bg-white border-gray-200 pt-6 dark:bg-gray-900">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
                ...
                <a href="{{ route('mitra.index') }}" class="mr-6 text-sm font-medium text-gray-500 dark:text-white hover:underline">Daftar Mitra</a>
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                        ...
                        <li>
                            <a href="{{ route('booking.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Pesanan Saya</a>
                        </li>
                        <li>
