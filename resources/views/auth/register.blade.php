...
<html lang="en">
  ...
  <body>
      <div class="min-h-screen bg-black flex justify-center items-center">
        <div class="absolute w-60 h-60 rounded-xl bg-white -top-5 -left-16 z-0 transform rotate-45 hidden md:block"></div>
          ...
          <div class="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
              <div>
                ...
                <div class="space-y-4">
                  ...
                  <input type="text" name="username" placeholder="Username" :value="old('username')" required="" class="block text-sm py-3 px-4 rounded-lg w-full border outline-none focus:border-primary focus:ring-2 focus:ring-primary"/>
                ...
                <div class="text-center mt-6">
                  <button type="submit"  class="py-3 w-64 text-xl text-white bg-black rounded-2xl">Simpan</button>
                </div>
            </div>
